...
# Last Modified:  Friday, 25th October 2019 1:30:48 am
...
def getParameters():
    ...
    parser.add_argument('--version', type=str, default='bc3')
    parser.add_argument('--train', type=str2bool, default=True)
    parser.add_argument('--experiment_description', type=str, default="实验验证BC的有效性,将透射系数初始化值改为1/class_num,去掉无条件部分，只留下条件部分")
    ...
    parser.add_argument('--dataset', type=str, default='cifar10', choices=['lsun', 'celeba','cifar10', 'cifar100'])
